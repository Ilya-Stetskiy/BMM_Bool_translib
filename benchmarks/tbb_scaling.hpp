...
// detail::median_of/kMeasuredRuns — общие с openmp_scaling.hpp, вынесены в
// scaling.hpp (см. комментарий там за тем, почему: ODR-конфликт, если оба
// backend'а нужны в одной единице трансляции — ровно наш случай в
// anf/test_anf.cpp).
//
