...
// сознательно меньше kMaxTruthTableVars в common.hpp: 2^16=65536 точек
// перебираются на каждую из 20 функций трансляции в каждом прогоне PR,
// 2^20 и тем более 2^kMaxTruthTableVars были бы уже заметно дороже без дополнительной
